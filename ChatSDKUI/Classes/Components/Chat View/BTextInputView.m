...
#define bTextViewVerticalPadding 12
...
-(instancetype) initWithFrame:(CGRect)frame {
  ...
  if (self) {
    ...
    UIColor * lightGrey = [UIColor colorWithRed:0.79 green:0.81 blue:0.85 alpha:1];
    
    // Set the text color
    _placeholderColor = lightGrey;
    ...
    _textView.layer.borderColor = lightGrey.CGColor;
    ...
    [_sendButton setTintColor: [UIColor colorWithRed:0.75 green:0.19 blue:0.25 alpha:1]];
    ...
    _sendButton.keepBottomInset.equal = bMargin;
